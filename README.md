...
Part 2: Detailed Code Structure
This is the exact folder structure you will create. Every file has a specific, isolated purpose, separating the AI logic from the Visual UI and the target codebase.
...
└── visual_hq/                        # 👁️ THE VIRTUAL OFFICE (React / Frontend)
    ...
    │   │   └── ShiftToggle.jsx       # "Day Shift" (Boss Mode) vs "Night Shift" (God Mode) toggle
    │   └── hooks/
...
Part 3: The Detailed README.md (The First Soul)
(Save this exactly as README.md in the root of your project)
